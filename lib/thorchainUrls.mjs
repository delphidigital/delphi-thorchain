...
// Obtener info de los ips: https://testnet.seed.thorchain.info/
...
const thorchainNodeIps = {
  testnet: process.env.TESTNET_NODE_IP || '18.157.111.52',
  chaosnet: process.env.CHAOSNET_NODE_IP || '157.90.98.200',
};
...
export const thorchainDataFetcher = (thorchainNetwork) => {
  ...
  return {
    ...
    loadHistoryDepths: async (asset) => {
      const [
        period24H, period1W, period1M, period3M, period6M, period1Y, period1HM, allTimePeriod
