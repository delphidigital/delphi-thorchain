...
const baseNodeIps = {
  testnet: process.env.TESTNET_NODE_IP || '18.193.176.70',
  chaosnet: process.env.CHAOSNET_NODE_IP || '3.65.216.254',
};
...
// v1 singlechain docs: http://157.90.98.196:8080/v1/doc
const thorchainSingleChainIps = {
  testnet: process.env.TESTNET_NODE_IP_SINGLECHAIN || '157.90.98.196',
  chaosnet: process.env.CHAOSNET_NODE_IP_SINGLECHAIN || '157.90.98.200',
};
...
async function updateNodeSource(blockchain) {
  try {
    ...
    let nodeIp = baseNodeIps[blockchain];
